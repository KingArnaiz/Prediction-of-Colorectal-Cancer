...
myFile  <-"~/data/Auto_OML/Results/RFSVM/RFSVM_Training_Results_mcombat.csv"
...
TestSample_Temp           <- read.csv("~/data/Auto_OML/Dataset/Testing_dataset/test_data_mcombat.csv")
...
write.table(Result, file = "~/data/Auto_OML/Results/RFSVM/RFSVM_Testing_Results_mcombat.csv",row.names=FALSE, na="",col.names=c("Ranked_feature_List","Test_Accuracy","Test_Sensitivity","Test_Specificity","Test_Positive_Predictive_Value", "Test_Negative_Predictive_Value","Test_AUC","Test_MCC","Test_Balanced_Accuracy"), sep=",")
